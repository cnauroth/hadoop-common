...
public class ViewFsBaseTest {
  ...
  public void setUp() throws Exception {
    ...
    fcTarget.mkdir(new Path(targetTestRoot,"dir3"),
        FileContext.DEFAULT_PERM, true);
    this.fileContextTestHelper.createFile(fcTarget,
  ...
  void initializeTargetTestRoot() throws IOException {
    targetTestRoot = this.fileContextTestHelper.getAbsoluteTestRootPath(
      fcTarget);
  ...
  public void tearDown() throws Exception {
    fcTarget.delete(this.fileContextTestHelper.getTestRootPath(fcTarget), true);
  }
  ...
  public void testOperationsThroughMountLinks() throws IOException {
    // Create file 
    this.fileContextTestHelper.createFileNonRecursive(fcView, "/user/foo");
    ...
    this.fileContextTestHelper.createFileNonRecursive(fcView,
    ...
    this.fileContextTestHelper.createFile(fcView,
    ...
    // mkdir
    fcView.mkdir(this.fileContextTestHelper.getTestRootPath(fcView,
        "/user/dirX"), FileContext.DEFAULT_PERM, false);
    ...
    // Rename a file 
    this.fileContextTestHelper.createFile(fcView, "/user/foo");
    ...
    Assert.assertTrue(isFile(fcView,
        this.fileContextTestHelper.getTestRootPath(fcView,"/user/fooBar")));
    ...
    Assert.assertTrue("Renamed dest should  exist as dir",
        isDir(fcView,
        this.fileContextTestHelper.getTestRootPath(fcView,"/user/dirFooBar")));
  ...
  public void testRenameAcrossMounts1() throws IOException {
    ...
    Assert.assertTrue(isFile(fc,
       this.fileContextTestHelper.getTestRootPath(fc,"/user2/fooBarBar")));
  ...
  public void testGetBlockLocations() throws IOException {
    ...
    this.fileContextTestHelper.createFile(fcTarget, targetFilePath, 10, 1024);
  ...
  public void testListOnInternalDirsOfMountTable() throws IOException {
    ...
    fs = this.fileContextTestHelper.containsPath(fcView, "/user", dirPaths);
      Assert.assertNotNull(fs);
      Assert.assertTrue("A mount should appear as symlink", fs.isSymlink());
    fs = this.fileContextTestHelper.containsPath(fcView, "/data", dirPaths);
      Assert.assertNotNull(fs);
      Assert.assertTrue("A mount should appear as symlink", fs.isSymlink());
    fs = this.fileContextTestHelper.containsPath(fcView, "/internalDir",
      dirPaths);
      Assert.assertNotNull(fs);
      Assert.assertTrue("InternalDirs should appear as dir", fs.isDirectory());
    fs = this.fileContextTestHelper.containsPath(fcView, "/danglingLink",
      dirPaths);
      Assert.assertNotNull(fs);
      Assert.assertTrue("A mount should appear as symlink", fs.isSymlink());
    fs = this.fileContextTestHelper.containsPath(fcView, "/linkToAFile",
      dirPaths);
      Assert.assertNotNull(fs);
      Assert.assertTrue("A mount should appear as symlink", fs.isSymlink());
      ...
      fs = this.fileContextTestHelper.containsPath(fcView,
  ...
  public void testResolvePathThroughMountPoints() throws IOException {
    ...
    fcView.mkdir(
        this.fileContextTestHelper.getTestRootPath(fcView, "/user/dirX"),
    ...
    fcView.mkdir(
        this.fileContextTestHelper.getTestRootPath(fcView, "/user/dirX/dirY"),
        FileContext.DEFAULT_PERM, false);
  ...
  public void testInternalMkdirExisting1() throws IOException {
    fcView.mkdir(this.fileContextTestHelper.getTestRootPath(fcView,
        "/internalDir"), FileContext.DEFAULT_PERM, false);
  }
  @Test(expected=AccessControlException.class) 
  ...
  public void testInternalMkdirNew() throws IOException {
    fcView.mkdir(this.fileContextTestHelper.getTestRootPath(fcView, "/dirNew"),
        FileContext.DEFAULT_PERM, false);
  }
  @Test(expected=AccessControlException.class) 
  ...
  public void testInternalCreate1() throws IOException {
    this.fileContextTestHelper.createFileNonRecursive(fcView, "/foo"); // 1 component
  }
  ...
  public void testInternalCreateMissingDir() throws IOException {
    this.fileContextTestHelper.createFile(fcView, "/missingDir/foo");
  }
  
  @Test(expected=AccessControlException.class) 
  public void testInternalCreateMissingDir2() throws IOException {
    this.fileContextTestHelper.createFile(fcView, "/missingDir/miss2/foo");
  }
  
  
  @Test(expected=AccessControlException.class) 
  public void testInternalCreateMissingDir3() throws IOException {
    this.fileContextTestHelper.createFile(fcView, "/internalDir/miss2/foo");
  }
