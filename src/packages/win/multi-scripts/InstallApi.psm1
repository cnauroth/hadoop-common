    ...
    $throwerror = $true)
{
    ...
    foreach ($property in $propertyList)
    {
        ...
        {
            if ( ($throwerror) -and ($nonEmptyFolderList.Length -gt 0) )
            {
