...
/**
 * A simple generic stack implementation using linked lists. The stack implementation has five
 * main operations:
 ...
 *      size	-- size returns the size of the stack
...
public class AzureLinkedStack<E>
{
	...
	private static class AzureLinkedNode<E>
	{
		...
		private AzureLinkedNode<E> next;// Reference to the next linked element on list.
		...
		/*
		 * Constructor builds a linked node with a specified successor. The successor may
		 * be null.
		 * 
	 ...
	 * 
	 * @return String
	 * 		String representation of all elements in the stack.
	 */
