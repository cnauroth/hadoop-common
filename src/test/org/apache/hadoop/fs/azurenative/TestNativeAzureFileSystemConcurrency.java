...
public class TestNativeAzureFileSystemConcurrency {
  ...
  private static Iterable<String> selectToString(
      final Iterable<Exception> collection) {
    return new Iterable<String>() {
      @Override
      public Iterator<String> iterator() {
        final Iterator<Exception> exceptionIterator = collection.iterator();
  ...
  public void testMultiThreadedOperation() throws Exception {
    ...
    final ConcurrentLinkedQueue<Exception> exceptionsEncountered =
